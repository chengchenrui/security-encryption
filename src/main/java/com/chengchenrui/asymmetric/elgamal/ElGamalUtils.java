package com.chengchenrui.asymmetric.elgamal;
...
/**
 * @author chengchenrui
 * @version Id: ElGamalUtils.java, v 0.1 2018.6.12 21:45 chengchenrui Exp $$
 */
public class ElGamalUtils {
    ...
    public static void jdkElgamal() {
        try {
            ...
            System.out
                .println("Public Key:" + Base64.encodeBase64String(elGamalPublicKey.getEncoded()));
            System.out.println(
                "Private Key:" + Base64.encodeBase64String(elGamalPrivateKey.getEncoded()));
